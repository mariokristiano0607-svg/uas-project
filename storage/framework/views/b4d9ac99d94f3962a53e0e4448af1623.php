    ...
    <div class="bg-gray-800 rounded-2xl shadow-xl border border-gray-700 p-8">
        ...
        <form class="space-y-6">
            ...
            <div class="flex gap-4">
                ...
                <a href="<?php echo e(route('dashboard')); ?>" class="bg-gray-600 hover:bg-gray-700 text-white font-medium py-3 px-8 rounded-lg transition">
                    Batal
                </a>
            </div>
        </form>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\final-project\final-project\resources\views/transaksi/create.blade.php ENDPATH**/ ?>