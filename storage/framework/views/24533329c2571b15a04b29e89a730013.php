...
<div class="p-6 lg:p-10">
    ...
    <div class="mb-10">
        <h1 class="text-4xl font-bold text-white mb-2">
            Selamat datang kembali, <span class="text-purple-400"><?php echo e(Auth::user()->name); ?></span>!
        </h1>
    ...
    <div class="bg-gray-800 border border-gray-700 rounded-2xl p-8 mb-10 shadow-2xl">
        <div class="flex flex-col md:flex-row items-center md:items-start gap-8">
            ...
            <div class="flex-1 text-center md:text-left">
                <p class="text-2xl font-bold text-white"><?php echo e(Auth::user()->name); ?></p>
                <p class="text-gray-400"><?php echo e(Auth::user()->email); ?></p>
                <span class="inline-block mt-3 px-6 py-2 rounded-full text-sm font-bold
                    <?php if(Auth::user()->role == 'admin'): ?> bg-red-900/70 text-red-200
                    <?php elseif(Auth::user()->role == 'staff'): ?> bg-amber-900/70 text-amber-200
                    <?php else: ?> bg-emerald-900/70 text-emerald-200 <?php endif; ?>">
        ...
        <div class="relative bg-gray-900/80 backdrop-blur-xl border border-gray-700 rounded-2xl p-7 shadow-2xl overflow-hidden">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-4xl font-extrabold text-white mt-3 count-up" data-target="<?php echo e($totalTransaksi ?? 0); ?>">
                        0
                    </p>
        ...
        <div class="relative bg-gray-900/80 backdrop-blur-xl border border-gray-700 rounded-2xl p-7 shadow-2xl overflow-hidden">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-4xl font-extrabold text-white mt-3 count-up" data-target="<?php echo e($totalUser ?? 0); ?>">
                        0
                    </p>
    ...
    <div class="relative group">
        ...
        <div class="relative bg-gray-900/80 backdrop-blur-xl border border-gray-700 rounded-2xl p-7 shadow-2xl overflow-hidden">
            <div class="flex items-center justify-between">
                ...
                <div class="p-4 
                    <?php if(Auth::user()->role == 'admin'): ?> bg-red-500/20 
                    <?php elseif(Auth::user()->role == 'staff'): ?> bg-amber-500/20 
                    <?php else: ?> bg-emerald-500/20 <?php endif; ?> 
                    rounded-2xl">
                    <svg class="w-12 h-12 
                        <?php if(Auth::user()->role == 'admin'): ?> text-red-400 
                        <?php elseif(Auth::user()->role == 'staff'): ?> text-amber-400 
                        <?php else: ?> text-emerald-400 <?php endif; ?>" 
            ...
            <div class="mt-4 h-2 bg-gray-800 rounded-full overflow-hidden">
                <div class="h-full w-full 
                    <?php if(Auth::user()->role == 'admin'): ?> bg-gradient-to-r from-red-500 to-pink-500
                    <?php elseif(Auth::user()->role == 'staff'): ?> bg-gradient-to-r from-amber-500 to-yellow-500
                    <?php else: ?> bg-gradient-to-r from-emerald-500 to-cyan-500 <?php endif; ?> 
            ...
            <?php if(Auth::user()->role == 'admin'): ?>
                <a href="<?php echo e(route('transaksi.index')); ?>" class="bg-indigo-600 hover:bg-indigo-700 text-white font-bold py-6 rounded-xl text-center shadow-lg transition transform hover:scale-105 flex items-center justify-center gap-3 text-lg">
                    Document Kelola Transaksi
                </a>
                <a href="<?php echo e(route('user.index')); ?>" class="bg-pink-600 hover:bg-pink-700 text-white font-bold py-6 rounded-xl text-center shadow-lg transition transform hover:scale-105 flex items-center justify-center gap-3 text-lg">
                    Users Kelola User
                </a>
            <?php elseif(Auth::user()->role == 'staff'): ?>
                <a href="<?php echo e(route('transaksi.index')); ?>" class="col-span-full bg-teal-600 hover:bg-teal-700 text-white font-bold py-6 rounded-xl text-center shadow-lg transition transform hover:scale-105 flex items-center justify-center gap-3 text-lg">
                    Pen Input Transaksi
                </a>
            <?php else: ?>
                <a href="<?php echo e(route('transaksi.create')); ?>" class="col-span-full bg-emerald-600 hover:bg-emerald-700 text-white font-bold py-6 rounded-xl text-center shadow-lg transition transform hover:scale-105 flex items-center justify-center gap-3 text-lg">
                    Plus Transaksi Baru
                </a>
            <?php endif; ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\final-project\final-project\resources\views/dashboard.blade.php ENDPATH**/ ?>