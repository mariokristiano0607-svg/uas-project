...
<div class="min-h-screen flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
    <div class="max-w-md w-full space-y-8">
        ...
        <form class="mt-8 space-y-6 bg-gray-800/50 backdrop-blur-sm p-8 rounded-2xl shadow-2xl border border-gray-700" method="POST" action="<?php echo e(route('login')); ?>">
            <?php echo csrf_field(); ?>
            ...
            <div class="flex items-center justify-between">
                ...
                <?php if(Route::has('password.request')): ?>
                    <a href="<?php echo e(route('password.request')); ?>" class="text-sm text-indigo-400 hover:text-indigo-300">
...
</html><?php /**PATH C:\laragon\www\final-project\final-project\resources\views/auth/login.blade.php ENDPATH**/ ?>